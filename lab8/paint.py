...
def main():
    ...
    icon = pygame.image.load('lab8\\paint\\icon.jpg')
    ...
    brush_png = pygame.transform.scale(pygame.image.load("lab8\\paint\\brush.jpg"), (20,20))
    eraser_png = pygame.transform.scale(pygame.image.load("lab8\\paint\\eraser.jpg"), (20,20))
    clear_png = pygame.transform.scale(pygame.image.load("lab8\\paint\\Clear.png"), (30, 30))
    save_png = pygame.transform.scale(pygame.image.load("lab8\\paint\\save.png"), (98, 50))
    ...
    def size_buttons():
        ...
        sz_btn = pygame.transform.scale(pygame.image.load("lab8\\paint\\size.png"), (25, 25))
